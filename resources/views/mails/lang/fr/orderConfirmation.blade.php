...
<table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #F5F5F5;width: 100%" cellpadding="0" cellspacing="0">
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            </div>    <div style="background-image:url('https://api.coatandclothes.shop/public/articles/65880coatnclothes.jpg');background-position:top center;background-repeat:repeat;;background-color:#935A5A;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid ">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-image:url('https://api.coatandclothes.shop/public/articles/65880coatnclothes.jpg');background-position:top center;background-repeat:repeat;;background-color:#935A5A" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:transparent;"><![endif]-->
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 5px; padding-left: 5px;"><!--<![endif]-->
                                    ...
                                    <div align="center" class="img-container center fixedwidth " style="padding-right: 20px;  padding-left: 20px;">
                                        ...
                                        <div style="line-height:20px;font-size:1px">&#160;</div>  <img class="center fixedwidth" align="center" border="0" src="https://coatandclothes.shop/static/favicon.png" alt="CoatNClothes" title="CoatNClothes" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 150px" width="150">
                                ...
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid #E8E8E8; border-left: 0px solid #E8E8E8; border-bottom: 0px solid #E8E8E8; border-right: 0px solid #E8E8E8; padding-top:20px; padding-bottom:25px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                                    ...
                                    <div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
                                        ...
                                        <a href="https://coatandclothes.shop/order/{{$obj->id}}" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #da0f68; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 215px; width: 175px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif;mso-border-alt: none">
                                            <span style="font-size:12px;line-height:24px;"><span style="font-size: 22px; line-height: 44px;" data-mce-style="font-size: 22px; line-height: 40px;">Allez à votre commande</span></span>
                                        </a>
                                        <!--[if mso]></center></v:textbox></v:roundrect></td></tr></table><![endif]-->
                                    </div>
                                ...
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                                    ...
                                    <div class="">
                                        ...
                                        <div style="line-height:120%;color:#FFFFFF;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 30px; padding-left: 30px; padding-top: 30px; padding-bottom: 30px;">
                                            <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">Copyright © 2017 - CoatNClothes</p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
